...
export const ProductCard:FC<ProductProps> = ({product, fullDescription = false, prefetchProduct}) => {

  return (
    <Link to={`/product/${product.id}`} onMouseEnter={()=> {
        prefetchProduct && prefetchProduct(product.id)
      }}>
      <Card
